...
<div class="card" >
<imgsrc="${newsDetails.thumbnail_url}" class="card-img-top" alt="...">
<div class="card-body">
...
<div class="col-md-2">
<imgsrc="${newsDetails.author.img ? newsDetails.author.img : 'The Author Image Is Not Founded'}" style="width: 50px; height: 50px;" class="rounded-circle" alt="...">
</div>
<div class="col-md-6">
...
<div class="col-md-4">
<h5 class="title"><i class="fa-light fa-eye"></i> ${newsDetails.total_view ? newsDetails.total_view : 'Total View Is Not Founded'}</h5>
</div>
</div>
</div>
    `;
